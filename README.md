...
| Role | Responsibility |
| :--- | :--- |
| **Developer A (AI/AWS)** | Bedrock/Groq Prompting, Satellite Data (GEE), Scoring Logic. | @NIKK-666
| **Developer B (UI/Integrator)** | Bhashini REST Integration, Twilio Webhooks, Streamlit UI. | @Harsh Srivastava
